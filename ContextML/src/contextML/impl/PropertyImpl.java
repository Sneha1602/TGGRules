...
public abstract class PropertyImpl extends MinimalEObjectImpl.Container implements Property {
		...
		if (provider != null && provider.eIsProxy()) {
			...
			if (provider != oldProvider) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ContextMLPackage.PROPERTY__PROVIDER, oldProvider, provider));
			}
		}
		return provider;
	}
	...
	public void setProvider(Provider newProvider) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ContextMLPackage.PROPERTY__PROVIDER, oldProvider, provider));
	}
