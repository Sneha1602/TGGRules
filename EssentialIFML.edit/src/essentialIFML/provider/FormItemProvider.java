...
/**
 * This is the item provider adapter for a {@link essentialIFML.Form} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FormItemProvider extends ViewComponentItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EssentialIFMLPackage.Literals.FORM__FIELD);
			childrenFeatures.add(EssentialIFMLPackage.Literals.FORM__EVENT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EssentialIFMLPackage.Literals.FORM__FIELD,
				 EssentialIFMLFactory.eINSTANCE.createField()));

		newChildDescriptors.add
			(createChildParameter
				(EssentialIFMLPackage.Literals.FORM__EVENT,
				 EssentialIFMLFactory.eINSTANCE.createEvent()));
	}
